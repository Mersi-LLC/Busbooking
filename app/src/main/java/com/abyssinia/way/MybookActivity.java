...
public class MybookActivity extends  AppCompatActivity  { 
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.myb, null);
			}
			
			final LinearLayout d = (LinearLayout) _view.findViewById(R.id.d);
			...
			final TextView b = (TextView) _view.findViewById(R.id.b);
			final TextView textview5 = (TextView) _view.findViewById(R.id.textview5);
			final TextView c = (TextView) _view.findViewById(R.id.c);
			final TextView textview6 = (TextView) _view.findViewById(R.id.textview6);
			final TextView e = (TextView) _view.findViewById(R.id.e);
			
			_border(d, "#ff8f00", "15");
			if (lm.get((int)_position).get("postid").toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
				if (lm.get((int)_position).containsKey("bookid")) {
					a.setText(lm.get((int)_position).get("bookid").toString());
				}
				else {
					
				}
				if (lm.get((int)_position).containsKey("dest")) {
					b.setText(lm.get((int)_position).get("dest").toString());
				}
				else {
					
				}
				if (lm.get((int)_position).containsKey("booktime")) {
					c.setText(lm.get((int)_position).get("booktime").toString());
				}
				else {
					
				}
				if (lm.get((int)_position).containsKey("name")) {
					e.setText(lm.get((int)_position).get("name").toString());
				}
				else {
