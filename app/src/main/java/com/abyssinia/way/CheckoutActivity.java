...
public class CheckoutActivity extends  AppCompatActivity  { 
	...
	private void initializeLogic() {
		...
		chapa.put("amount", trans.getString("amount", ""));
	...
	public void _first () {
		number_pay = 0;
		n = p.push().getKey().substring((int)(4), (int)(9));
		final AlertDialog dialog1 = new AlertDialog.Builder(CheckoutActivity.this).create();
		...
		TextView g = (TextView) inflate.findViewById(R.id.g);
		
		LinearLayout bg = (LinearLayout) inflate.findViewById(R.id.bg);
		b1.setText("Done");
		b2.setText("X");
		a.setText(pr.getString("fn", "").concat("  ".concat(pr.getString("ln", ""))));
		b.setText(pr.getString("ph", ""));
		c.setText("paid");
		d.setText(temp.getString("from", "").concat(" to ".concat(temp.getString("to", ""))));
		e.setText(new SimpleDateFormat("MMM dd").format(ca.getTime()).concat("  at  ".concat(new SimpleDateFormat("hh:mm  a").format(ca.getTime()))));
		f.setText(trans.getString("pass", ""));
		g.setText(n);
		...
		b1.setOnClickListener(new View.OnClickListener(){ public void onClick(View v){
				//action one
				my = new HashMap<>();
				my.put("name", pr.getString("fn", "").concat("  ".concat(pr.getString("ln", ""))));
				my.put("phone", pr.getString("ph", ""));
				my.put("payment", "paid");
				my.put("dest", temp.getString("from", "").concat(" to ".concat(temp.getString("to", ""))));
				...
				my.put("sitnumber", trans.getString("pass", ""));
				book.child(n).updateChildren(my);
				my = new HashMap<>();
				my.put("name", pr.getString("fn", "").concat("  ".concat(pr.getString("ln", ""))));
				my.put("phone", pr.getString("ph", ""));
				my.put("payment", "paid");
				...
				my.put("postid", FirebaseAuth.getInstance().getCurrentUser().getUid());
				my.put("sitnumber", trans.getString("pass", ""));
				story.child(n).updateChildren(my);
				my = new HashMap<>();
				my.put("postid", n);
				my.put("sitnumber", trans.getString("pass", ""));
				wenberoch.child(trans.getString("pass", "")).updateChildren(my);
				finish();
				dialog1.dismiss();
				dialog1.dismiss();
			}
